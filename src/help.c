...
static void help2(void)
{
    ...
    "Find and print the \033[4mNUM\033[0mth prime number."
    ...
    "when it was last quit (except for \033[1m--find\033[0m).\n\n   \033[1mExi"
    "t status:\033[0m\n\t0\tif the program has reached the  32-bit  integer li"
    "mit or\n\t\tthe last requested prime number,\n\t1\tif the  \033[4mNUM"
    "\033[0mth  prime number couldn't be found within the\n\t\t32-bit integer "
    "limit (with \033[1m--find\033[0m),\n\t84\tif an invalid argument was pass"
    "ed to the program.\n\n \033[1mPRINTING "
