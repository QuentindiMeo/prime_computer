...
{
    printf(
    "NUM\033[0m, \033[1m--until\033[0m=\033[4mNUM\033[0m\n\t\tCompute prime "
    "numbers until the \033[4mNUM\033[0mth prime number.\n\n\t\033[1m-E\033[0m"
    " \033[4mNUM\033[0m, \033[1m--end\033[0m=\033[4mNUM\033[0m\n\t\tCompute pr"
    "ime numbers while they're inferior to \033[4mNUM\033[0m.\n\n\t\033[1m-F"
...
int help(void)
{
    ...
    "--slow\033[0m=\033[4mMS\033[0m\n\t\tSlow down the program by waiting  "
    "\033[4mMS\033[0m milliseconds after\n\t\tevery iteration. I'm suggesting "
    "50, the limit is 60,000.\n\n\t\033[1m--store\033[0m\n\t\tMake the program"
    " store the results it finds in  a  file,\n\t\t\033[3mcalculations_prime."
    "txt\033[0m, allowing the program to continue\n\t\twhere  it ended when it"
    " was last quit.  Be  careful,  it\n\t\tgrows exponentially fast in size "
    "(155KB for results from\n\t\t0 to 9,999).\n\n\t\033[1m-u\033[0m \033[4m");
    help2();
    return (SUCCESS);
}
